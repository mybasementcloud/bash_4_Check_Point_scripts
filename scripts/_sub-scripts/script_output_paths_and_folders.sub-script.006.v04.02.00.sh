...
FinalizeOutputAndLogPaths () {
    ...
    if $CLIparm_NOHUP; then
        ...
        export script2nohupstdoutlog=$outputpathroot/$script2nohup.nuhup.stdout.*.txt
        export script2nohupstderrlog=$outputpathroot/$script2nohup.nuhup.stderr.*.txt
        export script2watchnohupwork=$outputpathroot/$script2nohup.nuhup.watchme.*.sh
        export script2cleannohupwork=$outputpathroot/$script2nohup.nuhup.cleanup.$DATEDTGS.sh
        ...
        echo >> $logfilepath
        echo '------------------------------------------------------------------------------' >> $logfilepath
        echo 'Dump nohup cleanup script:  '$script2cleannohupwork >> $logfilepath
        echo '------------------------------------------------------------------------------' >> $logfilepath
        echo >> $logfilepath
