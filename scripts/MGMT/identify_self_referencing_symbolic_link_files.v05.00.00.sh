...
for f in $(find . -type l); do 
    ...
    if [ "$targetlinktype" = "directory" ]; then
        echo 'A directory!' $f | tee -a -i "${outputfilefqfn}"
        
        echo '----------------------------------------------------------------------------' | tee -a -i "${outputfilefqfn}"
        
        echo 'Drop in to actual link folder: '$targetactualfile | tee -a -i "${outputfilefqfn}"
        
        pushd $targetactualfile >> "${outputfilefqfn}"
        
        echo | tee -a -i "${outputfilefqfn}"
        
        echo 'Current path :  '`pwd` | tee -a -i "${outputfilefqfn}"
        ls -alhi >> "${outputfilefqfn}"
        echo | tee -a -i "${outputfilefqfn}"
        ...
        for g in $(find . -type l); do 
            ...
            echo 'locallinktype = '$locallinktype  | tee -a -i "${outputfilefqfn}"
            
            if [ "$locallinktype" = "directory" ]; then
                echo 'A directory!' $g | tee -a -i "${outputfilefqfn}"
                ...
                echo 'Local Link File Name (as found):  '$localfilename '('$localfile')  Local Actual File :  '$localactualfile | tee -a -i "${outputfilefqfn}"
                ls -alhi $g | tee -a -i "${outputfilefqfn}"
                ...
                if [ $localactuallinkloopscheckresult ] ; then 
                    ...
                    if $KillCircularSymLinks ; then
                        ...
                        #echo 'testing....'
                        rm $g | tee -a -i "${outputfilefqfn}"
                    else
                        echo 'Keep Circular SymLink File!' | tee -a -i "${outputfilefqfn}"
                    fi
                else
                ...
                echo 'Not A directory!' $g | tee -a -i "${outputfilefqfn}"
            fi
        ...
        echo 'Returned path :  '`pwd` | tee -a -i "${outputfilefqfn}"
        ...
        echo 'Not a directory!  '$f'  Skipping...' | tee -a -i "${outputfilefqfn}"
    fi
