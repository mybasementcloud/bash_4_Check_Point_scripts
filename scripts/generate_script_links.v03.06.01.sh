...
file_gaia_version=determine_gaia_version_and_installation_type.v03.02.00.sh
file_do_script_nohup=do_script_nohup.v03.00.00.sh

file_godump=go_dump_folder_now.v03.00.00.sh
file_godumpdtg=go_dump_folder_now_dtg.v03.00.00.sh

file_goChgLogdtg=go_change_log_folder_now_dtg.v03.00.00.sh

file_mkdump=make_dump_folder_now.v03.00.00.sh
file_mkdumpdtg=make_dump_folder_now_dtg.v03.00.00.sh
...
ln -sf $sourcefolder/$file_do_script_nohup $linksfolder/do_script_nohup
ln -sf $sourcefolder/$file_do_script_nohup $workingroot/do_script_nohup
...
file_configcapture=config_capture.006.v03.06.00.sh

file_interface_info=show_interface_information.v03.02.00.sh
...
file_GAIA_update_gaia_rest_api=update_gaia_rest_api.006.v03.00.00.001.sh
file_GAIA_update_gaia_dynamic_cli=update_gaia_dynamic_cli.006.v03.00.00.001.sh


ln -sf $sourcefolder/$file_GAIA_update_gaia_rest_api $linksfolder/update_gaia_rest_api
ln -sf $sourcefolder/$file_GAIA_update_gaia_dynamic_cli $linksfolder/update_gaia_dynamic_cli

if $IsR8XVersion ; then
    
    ln -sf $sourcefolder/$file_GAIA_update_gaia_rest_api $workingroot/update_gaia_rest_api
    ln -sf $sourcefolder/$file_GAIA_update_gaia_dynamic_cli $workingroot/update_gaia_dynamic_cli
...
file_watch_accel_stats=watch_accel_stats.v03.01.00.sh
file_set_inf_log_implied=set_informative_logging_implied_rules_on_R8x.v03.02.00.sh
file_reset_hitcount_w_bu=reset_hit_count_with_backup.v03.02.00.sh
...
file_healthdump=run_healthcheck_to_dump_dtg.v03.02.00.sh
file_cpservicecheck=check_status_checkpoint_services.v03.03.00.sh
...
file_backup_mds=backup_mds_ugex.v03.02.00.sh
file_backup_mds_w_logs=backup_mds_w_logs_ugex.v03.02.00.sh

file_report_mdsstat=report_mdsstat.v03.02.00.sh
file_watch_mdsstat=watch_mdsstat.v03.02.00.sh
file_show_domains_in_array=show_all_domains_in_array.v03.02.00.sh
...
file_rem_zl_sessions=remove_zerolocks_sessions.v03.00.00.sh
file_rem_zl_sessions_webapi=remove_zerolocks_web_api_sessions.v03.00.00.sh
file_show_zl_sessions=show_zerolocks_sessions.v03.00.00.sh
file_show_zl_sessions_webapi=show_zerolocks_web_api_sessions.v03.00.00.sh
...
file_smev_backup=SmartEvent_Backup_R8X.v03.02.00.sh
file_smev_restore=SmartEvent_Restore_R8X.v03.02.0X-NR.sh
file_smev_reset_indexing=Reset_SmartLog_Indexing_Back_X_Days.v03.02.00.sh
file_smev_nuke=NUKE_ALL_LOGS_AND_INDEXES.v03.02.00.sh
...
file_migrate_export_npm=migrate_export_npm_ugex.v03.02.00.sh
file_migrate_export_w_logs_npm=migrate_export_w_logs_npm_ugex.v03.02.00.sh

file_migrate_export_epm=migrate_export_epm_ugex.v03.02.00.sh
file_migrate_export_w_logs_epm=migrate_export_w_logs_epm_ugex.v03.02.00.sh

file_mgmt_report=report_cpwd_admin_list.v03.02.00.sh
file_mgmt_restart=restart_mgmt.v03.02.00.sh
file_mgmt_watch=watch_cpwd_admin_list.v03.02.00.sh

file_reset_hitcount_sms=reset_hit_count_on_R80_SMS_commands.001.v00.01.00.sh
...
file_add_allias_all=add_alias_commands.all.v03.02.00.sh
