...
export folderstdversion=v04.37.00
...
export subscriptsstdversion=v04.12.00
...
file_hostupdatecripts_003=updatescripts.sample.$folderstdversion.sh
...
#ln -sf $sourcefolder/$file_hostupdatecripts_003 $linksfolder/updatescripts.sample >> $logfilepath
...
if [ "$sys_type_GW" == "true" ]; then
    ...
    #ln -sf $sourcefolder/$file_GW_009 $workingroot/fix_gw_missing_updatable_objects >> $logfilepath
...
if [ ! -r $sourcefolder ] ; then
    ...
    file_GW_CORE_003=SK106251/SK106251_IPv4_InstallSetup.v02.00.00.sh
...
ln -sf $sourcefolder/$file_MDM_005 $linksfolder/show_domains_in_array >> $logfilepath
...
if [ "$sys_type_MDS" == "true" ]; then
    ...
    #ln -sf $sourcefolder/$file_MDM_005 $workingroot/show_domains_in_array >> $logfilepath
...
ln -sf $sourcefolder/$file_SMEV_005 $linksfolder/LogExporter_Backup >> $logfilepath
...
if [ "$sys_type_SMS" == "true" ] || [ "$sys_type_MDS" == "true" ]; then
    ...
    ln -sf $sourcefolder/$file_SMEV_005 $workingroot/LogExporter_Backup >> $logfilepath
    
    CopyToB4CPScriptsAndLink $sourcefolder/$file_SMEV_005 $scriptsbase $scriptsrepository LogExporter_Backup >> $logfilepath
