...
export archivepathbase=${currentpath}
export archivestartfolder=scripts
#export archivefilename=${archivestartfolder}.${ScriptDTGTZ}.${BASHScriptVersion}.${ScriptRevision}.${ScriptSubRevision}.tgz
export archivefilename=b4CP.${archivestartfolder}.${BASHScriptVersion}.${ScriptRevision}.tgz
...
export archivecopyfilename=b4CP.${archivestartfolder}.${BASHScriptVersion}.${ScriptRevision}.${ScriptDTGTZ}.tgz
