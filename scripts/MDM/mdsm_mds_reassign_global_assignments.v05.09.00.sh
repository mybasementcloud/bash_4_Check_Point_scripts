...
if ${IsR8XVersion} ; then
    ...
    cat global-assignment.csv | tee -a -i ${logfilepath}
    
    echo | tee -a -i ${logfilepath}
    echo 'Execute the batch of global-assignments...' | tee -a -i ${logfilepath}
    echo | tee -a -i ${logfilepath}
    
    mgmt_cli -r true --port ${MGMTSSLPORT} -f json assign-global-assignment --batch global-assignment.csv | tee -a -i ${logfilepath}
