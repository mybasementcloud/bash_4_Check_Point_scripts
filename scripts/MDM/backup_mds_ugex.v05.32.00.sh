...
export BASHScriptShortName=backup_mds_ugex
...
export command2run='mds_backup -b -l -s -d'
export outputfilename=${outputfileprefix}'_mds_backup-blsd'${outputfilesuffix}${outputfiletype}
...
mds_backup -b -l -s -d "${outputfilepath}" | tee -a -i ${outputfilefqfn}
