...
export command2run=execute_hcp
...
echo '----------------------------------------------------------------------------' | tee -a -i ${outputfilefqfn}
echo 'Execute Command with output to Output Path : ' | tee -a -i ${outputfilefqfn}
echo ' - Execute Command    : hcp -r all -f json' | tee -a -i ${outputfilefqfn}
echo ' - Output Path        : '${outputfilefqfn} | tee -a -i ${outputfilefqfn}
echo '----------------------------------------------------------------------------' | tee -a -i ${outputfilefqfn}
echo >> ${outputfilefqfn}

hcp -r all -f json >> ${outputfilefqfn} 2>&1

echo >> ${outputfilefqfn}
echo '----------------------------------------------------------------------------' | tee -a -i ${outputfilefqfn}
echo 'Execute Command with output to Output Path : ' | tee -a -i ${outputfilefqfn}
echo ' - Execute Command    : hcp --show-last-full' | tee -a -i ${outputfilefqfn}
echo ' - Output Path        : '${outputfilefqfn} | tee -a -i ${outputfilefqfn}
echo '----------------------------------------------------------------------------' | tee -a -i ${outputfilefqfn}
echo | tee -a -i ${outputfilefqfn}

hcp --show-last-full >> ${outputfilefqfn} 2>&1

export hcplastrunreport=/var/log/hcp/last/hcp_last_report.tar.gz

echo >> ${outputfilefqfn}
echo '----------------------------------------------------------------------------' | tee -a -i ${outputfilefqfn}
echo 'Copy last results for hcp to local dump folder : ' | tee -a -i ${outputfilefqfn}
echo ' - Source Path        : '${hcplastrunreport} | tee -a -i ${outputfilefqfn}
echo ' - Output Path        : '${outputfilefqdn} | tee -a -i ${outputfilefqfn}
echo '----------------------------------------------------------------------------' | tee -a -i ${outputfilefqfn}
echo | tee -a -i ${outputfilefqfn}

echo | tee -a -i ${outputfilefqfn}
echo 'Moving hcp results files to '${outputfilefqdn} | tee -a -i ${outputfilefqfn}
echo | tee -a -i ${outputfilefqfn}

mv ${hcplastrunreport} ${outputfilefqdn}/ | tee -a -i ${outputfilefqfn}
...
cat ${outputfilefqfn} >> ${logfilepath}
