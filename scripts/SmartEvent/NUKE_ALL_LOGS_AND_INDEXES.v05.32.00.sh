...
export BASHScriptFileNameRoot=NUKE_ALL_LOGS_AND_INDEXES
...
case "${gaiaversion}" in
    R80 | R80.10 | R80.20.M1 | R80.20.M2 | R80.20 | R80.30 | R80.40 | R81 | R81.10 ) 
...
if [ ! -r $garbagedumpfolder ] ; then
    mkdir -pv $garbagedumpfolder >> ${outputfilefqdn}
    chmod 775 $garbagedumpfolder >> ${outputfilefqdn}
else
    chmod 775 $garbagedumpfolder >> ${outputfilefqdn}
fi

if [ ! -r $garbagedumpfolder/log ] ; then
    mkdir -pv $garbagedumpfolder/log >> ${outputfilefqdn}
    chmod 775 $garbagedumpfolder/log >> ${outputfilefqdn}
else
    chmod 775 $garbagedumpfolder/log >> ${outputfilefqdn}
fi

if [ ! -r $garbagedumpfolder/log/blob ] ; then
    mkdir -pv $garbagedumpfolder/log/blob >> ${outputfilefqdn}
    chmod 775 $garbagedumpfolder/log/blob >> ${outputfilefqdn}
else
    chmod 775 $garbagedumpfolder/log/blob >> ${outputfilefqdn}
fi

ls -alhR $garbagedumpfolder | tee -a -i "${outputfilefqdn}"
...
fw logswitch | tee -a -i ${outputfilefqdn}
fw logswitch -audit | tee -a -i ${outputfilefqdn}

cpstop | tee -a -i ${outputfilefqdn}
 
#Backup and remove logs and log blobs
#

echo | tee -a -i "${outputfilefqdn}"
echo 'Move log and audit log files to '$garbagedumpfolder/log | tee -a -i "${outputfilefqdn}"
echo | tee -a -i "${outputfilefqdn}"

mv ${FWDIR}/log/*_??????.log* $garbagedumpfolder/log | tee -a -i ${outputfilefqdn}
mv ${FWDIR}/log/*_??????.adt* $garbagedumpfolder/log | tee -a -i ${outputfilefqdn}

echo | tee -a -i "${outputfilefqdn}"
echo 'Move blob files to '$garbagedumpfolder/log/blob | tee -a -i "${outputfilefqdn}"
echo | tee -a -i "${outputfilefqdn}"

mv ${FWDIR}/log/blob/* $garbagedumpfolder/log/blob | tee -a -i ${outputfilefqdn}
...
echo | tee -a -i "${outputfilefqdn}"
echo 'Move index files to '$garbagedumpfolder | tee -a -i "${outputfilefqdn}"
echo | tee -a -i "${outputfilefqdn}"
...
echo | tee -a -i "${outputfilefqdn}"
echo 'Execute Reset Indexing value to 1 with output to : '${outputfilefqdn} | tee -a -i "${outputfilefqdn}"
echo | tee -a -i "${outputfilefqdn}"
echo '----------------------------------------------------------------------------' | tee -a -i "${outputfilefqdn}"
echo | tee -a -i "${outputfilefqdn}"
...
echo '] ./log_indexer -days_to_index 1' | tee -a -i "${outputfilefqdn}"
echo | tee -a -i "${outputfilefqdn}"

pushd ${INDEXERDIR}
pwd ${INDEXERDIR} | tee -a -i "${outputfilefqdn}"

./log_indexer -days_to_index 1 | tee -a -i "${outputfilefqdn}"
...
if ${CLIparm_NOSTART}; then
    ...
    echo 'Starting Check Point services...' | tee -a -i "${outputfilefqdn}"
    echo | tee -a -i "${outputfilefqdn}"
...
if [ -r nul ] ; then
    rm nul >> ${outputfilefqdn}
fi

if [ -r None ] ; then
    rm None >> ${outputfilefqdn}
fi

echo | tee -a -i "${outputfilefqdn}"
echo 'List folder : '$garbagedumpfolder | tee -a -i "${outputfilefqdn}"
ls -alhR $garbagedumpfolder | tee -a -i "${outputfilefqdn}"
echo | tee -a -i "${outputfilefqdn}"

echo | tee -a -i "${outputfilefqdn}"
echo 'List folder : '${outputpathbase} | tee -a -i "${outputfilefqdn}"
ls -alh ${outputpathbase} | tee -a -i "${outputfilefqdn}"
echo | tee -a -i "${outputfilefqdn}"

echo | tee -a -i "${outputfilefqdn}"
echo 'Output location for removed index files : '${garbagedumpfolder} | tee -a -i "${outputfilefqdn}"
echo 'Output location for all results is here : '${outputpathbase} | tee -a -i "${outputfilefqdn}"
echo 'Log results documented in this log file : '${logfilepath} | tee -a -i "${outputfilefqdn}"
echo | tee -a -i ${outputfilefqdn}
