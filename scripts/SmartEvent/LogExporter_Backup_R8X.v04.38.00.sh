...
if [ "$sys_type_SMS" == "true" ]; then
    ...
    BackupLogExporterTarget "$outputfilepath" "$outputfilefqpn" "$backupfilefqpn"
    ...
    for j in "${DOMAINSARRAY[@]}" ; do
        ...
        BackupLogExporterTarget "$outputfilepath/$sourcedomain" "$outputfilefqpn" "$backupfilefqpn" "$sourcedomain"
