...
export folderstdversion=v05.38.00
...
export subscriptsstdversion=v05.38.00
...
export apisubscriptsstdversion=v00.70.00
...
if [ -r ${customerpathroot} ] ; then
    if [ -r ${sourcefolder} ] ; then
        if [ -r ${sourcefolder}/JQ ] ; then
            if [ -r ${customerpathroot}/${workingdir}/JQ ] ; then
                rm -f -r -d -v ${customerpathroot}/${workingdir}/JQ | tee -a -i ${logfilepath}
            fi
        fi
        if [ -r ${sourcefolder}/JQ_v01.06.00 ] ; then
            if [ -r ${customerpathroot}/${workingdir}/JQ_v01.06.00 ] ; then
                rm -f -r -d -v ${customerpathroot}/${workingdir}/JQ_v01.06.00 | tee -a -i ${logfilepath}
            fi
        fi
        if [ -r ${sourcefolder}/JQ_v01.08.01 ] ; then
            if [ -r ${customerpathroot}/${workingdir}/JQ_v01.08.01 ] ; then
                rm -f -r -d -v ${customerpathroot}/${workingdir}/JQ_v01.08.01 | tee -a -i ${logfilepath}
            fi
        fi
        #cp -a -f -v ${sourcefolder}/ ${customerpathroot}/${workingdir}/ | tee -a -i ${logfilepath}
        cp -a -f -v ${sourcefolder}/ ${customerpathroot}/ | tee -a -i ${logfilepath}
    fi
fi
...
action_file_config_000=config_details_capture.action_script.XXX.${folderstdversion}.sh
action_file_config_001=config_details_capture.action_script.CP_Gateway_or_Cluster.${folderstdversion}.sh
action_file_config_002=config_details_capture.action_script.CP_Security_Management.${folderstdversion}.sh
action_file_config_003=config_details_capture.action_script.Security_and_Crypto.${folderstdversion}.sh
action_file_config_004=config_details_capture.action_script.SmartLog_SmartEvent.${folderstdversion}.sh
action_file_config_005=config_details_capture.action_script.hardware.${folderstdversion}.sh
action_file_config_006=config_details_capture.action_script.installation.${folderstdversion}.sh
action_file_config_007=config_details_capture.action_script.networking.${folderstdversion}.sh
action_file_config_008=config_details_capture.action_script.system_common.${folderstdversion}.sh
action_file_config_009=config_details_capture.action_script.user_environment.${folderstdversion}.sh
...
if [ "${sys_type_GW}" == "true" ]; then
    ...
    # #fix IDE bash parsing display so ignore this # 10
...
if [ ! -r ${sourcefolder} ] ; then
    ...
    #ln -sf ${sourcefolder}/${file_GW_CORE_002} ${linksfolder}/XX >> ${logfilepath}
    
    #ln -sf ${sourcefolder}/${file_GW_CORE_003} ${linksfolder}/XX >> ${logfilepath}
    ...
    if [ "${sys_type_GW}" == "true" ] ; then
        ...
        #ln -sf ${sourcefolder}/${file_GW_CORE_002} ${workingroot}/XX >> ${logfilepath}
        #ln -sf ${sourcefolder}/${file_GW_CORE_003} ${workingroot}/XX >> ${logfilepath}
...
file_SDWAN_001=fix_DHCP_DNS_Override_for_SDWAN.${folderstdversion}.sh
file_SDWAN_002=append_to_dhclient-enter-hooks.EXAMPLE.bash

ln -sf ${sourcefolder}/${file_SDWAN_001} ${linksfolder}/fix_DHCP_DNS_Override_for_SDWAN >> ${logfilepath}

CopyToB4CPScriptsAndLink ${sourcefolder}/${file_SDWAN_001} ${scriptsbase} ${scriptsrepository} fix_DHCP_DNS_Override_for_SDWAN

if [ "${sys_type_SMS}" == "true" ]; then
    
    ln -sf ${sourcefolder}/${file_SDWAN_001} ${workingroot}/fix_DHCP_DNS_Override_for_SDWAN >> ${logfilepath}
...
export workingdir2=SD-WAN.CORE
export sourcefolder2=${workingbase}/${workingdir2}

file_SDWAN_003=append_to_dhclient-enter-hooks.bash
file_SDWAN_004=append_to_dhclient-enter-hooks.SMCIAS.bash
file_SDWAN_005=append_to_dhclient-enter-hooks.TE100X.bash
file_SDWAN_006=append_to_dhclient-enter-hooks.3920.bash
file_SDWAN_007=append_to_dhclient-enter-hooks.3200.bash

if [ -r ${sourcefolder2}/${file_SDWAN_003} ] ; then
    cp ${sourcefolder2}/${file_SDWAN_003} ${sourcefolder}/${file_SDWAN_003} >> ${logfilepath}
fi

if [ -r ${sourcefolder2}/${file_SDWAN_004} ] ; then
    cp ${sourcefolder2}/${file_SDWAN_004} ${sourcefolder}/${file_SDWAN_004} >> ${logfilepath}
fi

if [ -r ${sourcefolder2}/${file_SDWAN_005} ] ; then
    cp ${sourcefolder2}/${file_SDWAN_005} ${sourcefolder}/${file_SDWAN_005} >> ${logfilepath}
fi

if [ -r ${sourcefolder2}/${file_SDWAN_006} ] ; then
    cp ${sourcefolder2}/${file_SDWAN_006} ${sourcefolder}/${file_SDWAN_006} >> ${logfilepath}
fi

if [ -r ${sourcefolder2}/${file_SDWAN_007} ] ; then
    cp ${sourcefolder2}/${file_SDWAN_007} ${sourcefolder}/${file_SDWAN_007} >> ${logfilepath}
fi
...
export folderstdversion=v00.70.00.000
export sourcefolder=${workingbase}/${workingdir}
export linksfolder=${linksbase}/${workingdir}
if [ ! -r ${linksfolder} ] ; then
    mkdir -pv ${linksfolder} | tee -a -i ${logfilepath}
...
#ln -sf ${sourcefolder}/${file_SMS_008} ${linksfolder}/XX >> ${logfilepath}

if [ -r ${sourcefolder}/${file_SMS_009} ] ; then
...
file_SMS_CORE_001=CORE-G3_install_policy.$folderstdversion.raw.sh

ln -sf ${sourcefolder}/${file_SMS_CORE_001} ${linksfolder}/CORE-G3_install_policy >> ${logfilepath}

#if [ "${sys_type_SMS}" == "true" ]; then
    
    # These have been replaced with alias commands or alias links
    #
    #ln -sf ${sourcefolder}/${file_SMS_CORE_001} ${workingroot}/CORE-G3_install_policy >> ${logfilepath}
    
    #CopyToB4CPScriptsAndLink ${sourcefolder}/${file_SMS_CORE_001} ${scriptsbase} ${scriptsrepository} CORE-G3_install_policy
