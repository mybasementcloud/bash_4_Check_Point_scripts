...
ln -sf $sourcefolder/report_mdsstat.v00.04.00.sh $linksfolder/report_mdsstat
ln -sf $sourcefolder/watch_mdsstat.v00.04.00.sh $linksfolder/watch_mdsstat

if [ "$sys_type_MDS" == "true" ]; then
    
    ln -sf $sourcefolder/mds_backup_ugex_001_v00.06.01.sh $workingroot/mds_backup_ugex
    ln -sf $sourcefolder/report_mdsstat.v00.04.00.sh $workingroot/report_mdsstat
    ln -sf $sourcefolder/watch_mdsstat.v00.04.00.sh $workingroot/watch_mdsstat
...
ln -sf $sourcefolder/migrate_export_ugex_001_v00.08.00.sh $linksfolder/migrate_export_ugex
ln -sf $sourcefolder/restart_mgmt.v00.05.00.sh $linksfolder/restart_mgmt
ln -sf $sourcefolder/report_cpwd_admin_list.v00.04.00.sh $linksfolder/report_cpwd_admin_list
ln -sf $sourcefolder/watch_cpwd_admin_list.v00.04.00.sh $linksfolder/watch_cpwd_admin_list
...
if [ "$sys_type_SMS" == "true" ]; then
    ...
    ln -sf $sourcefolder/migrate_export_ugex_001_v00.08.00.sh $workingroot/migrate_export_ugex
    ln -sf $sourcefolder/restart_mgmt.v00.05.00.sh $workingroot/restart_mgmt
    ln -sf $sourcefolder/report_cpwd_admin_list.v00.04.00.sh $workingroot/report_cpwd_admin_list
    ln -sf $sourcefolder/watch_cpwd_admin_list.v00.04.00.sh $workingroot/watch_cpwd_admin_list
