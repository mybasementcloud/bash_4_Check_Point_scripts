...
touch --reference=__root_script_config.sh Common.CORE/*.sh
touch --reference=__root_script_config.sh Common.CORE/help*/*.help
...
touch --reference=__root_script_config.sh SD-WAN/*.sh
touch --reference=__root_script_config.sh SD-WAN/*.bash
touch --reference=__root_script_config.sh SD-WAN/help*/*.help
touch --reference=__root_script_config.sh SD-WAN.CORE/*.sh
touch --reference=__root_script_config.sh SD-WAN.CORE/*.bash
touch --reference=__root_script_config.sh SD-WAN.CORE/help*/*.help
...
touch --reference=__root_script_config.sh SMS.CORE/*.sh
touch --reference=__root_script_config.sh SMS.CORE/help*/*.help
