...
dos2unix Common.CORE/*.sh
dos2unix Common.CORE/help.$BASHScriptVersion/*.help
dos2unix Config/*.sh
...
dos2unix SD-WAN/*.sh
dos2unix SD-WAN/*.bash
dos2unix SD-WAN/help.$BASHScriptVersion/*.help
dos2unix SD-WAN.CORE/*.sh
dos2unix SD-WAN.CORE/*.bash
dos2unix SD-WAN.CORE/help.$BASHScriptVersion/*.help
...
dos2unix SMS.CORE/*.sh
dos2unix SMS.CORE/help.$BASHScriptVersion/*.help
