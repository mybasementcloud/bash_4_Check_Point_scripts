...
export BASHScriptFileNameRoot=reset_hit_count_with_backup
...
mkdir -pv $bufilepath | tee -a -i ${logfilepath}

echo | tee -a -i ${logfilepath}

echo 'Stop gateway services' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}
...
if ${CLIparm_NOSTART}; then
    ...
    echo 'Starting Check Point services...' | tee -a -i ${logfilepath}
    echo | tee -a -i ${logfilepath}

    cpstart | tee -a ${logfilepath}
fi
