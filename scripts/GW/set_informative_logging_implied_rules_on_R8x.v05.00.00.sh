...
export BASHScriptFileNameRoot=set_informative_logging_implied_rules_on_R8x
...
echo 'Check Value :  fw_log_informative_implied_rules_enabled' | tee -a -i ${outputfile}
echo | tee -a -i ${outputfile}
