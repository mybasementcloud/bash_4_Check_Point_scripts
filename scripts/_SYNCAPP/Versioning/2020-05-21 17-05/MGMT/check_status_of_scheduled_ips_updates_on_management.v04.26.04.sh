...
#
#
ScriptDate=2020-03-31
ScriptVersion=04.26.04
ScriptRevision=007
...
DoAndDocumentActionSameFile grep "starting scheduled IPS update" cpm.elg.10
DoAndDocumentActionSameFile grep "starting scheduled IPS update" cpm.elg.9
DoAndDocumentActionSameFile grep "starting scheduled IPS update" cpm.elg.8
DoAndDocumentActionSameFile grep "starting scheduled IPS update" cpm.elg.7
DoAndDocumentActionSameFile grep "starting scheduled IPS update" cpm.elg.6
DoAndDocumentActionSameFile grep "starting scheduled IPS update" cpm.elg.5
DoAndDocumentActionSameFile grep "starting scheduled IPS update" cpm.elg.4
DoAndDocumentActionSameFile grep "starting scheduled IPS update" cpm.elg.3
DoAndDocumentActionSameFile grep "starting scheduled IPS update" cpm.elg.2
DoAndDocumentActionSameFile grep "starting scheduled IPS update" cpm.elg.1
DoAndDocumentActionSameFile grep "starting scheduled IPS update" cpm.elg
