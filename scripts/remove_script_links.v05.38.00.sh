...
CleanScriptLinks ${workingroot} make_snapshot_and_backup_to_ftp_target
CleanScriptLinks ${workingroot} make_local_snapshot_and_backup
...
if [ ! -r ${sourcefolder} ] ; then
    ...
    CleanScriptLinks ${workingroot} enable_usfw_force_override

    # Clear legacy scripts
...
#rm ${workingroot}/install_hcp_offline | tee -a -i ${logfilepath}
#rm ${workingroot}/run_hcp_and_copy_files | tee -a -i ${logfilepath}

#CleanScriptLinks ${workingroot} install_hcp_offline
CleanScriptLinks ${workingroot} run_hcp_and_copy_files
...
#rm ${workingroot}/fix_mgmt_missing_updatable_objects | tee -a -i ${logfilepath}
...
CleanScriptLinks ${workingroot} fix_mgmt_missing_updatable_objects
...
CleanScriptLinks ${workingroot} fix_DHCP_DNS_Override_for_SDWAN
...
export linksfolder=${linksbase}/${workingdir}
    ...
    #rm ${workingroot}/CORE-G3_install_policy | tee -a -i ${logfilepath}
    
    #CleanScriptLinks ${workingroot} G3_install_policy
...
rm ${workingroot}/reset_all_users_home_profile_files | tee -a -i ${logfilepath}
...
CleanScriptLinks ${workingroot} reset_all_users_home_profile_files
...
CleanB4CPScriptsAndLinks ${scriptsbase} ${scriptsrepository} reset_all_users_home_profile_files
