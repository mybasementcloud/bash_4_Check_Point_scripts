...
#
# SCRIPT Template for bash scripts subscripts or action scripts
#
#
...
SubScriptFileNameRoot=_template_sub_scripts.subscript
SubScriptShortName="_template_sub_scripts.${SubScriptsLevel}"
SubScriptDescription="Template for bash scripts subscripts or action scripts"
