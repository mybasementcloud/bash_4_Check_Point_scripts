...
#
#
SubScriptDate=2020-11-20
SubScriptVersion=04.45.00
SubScriptRevision=020
TemplateVersion=04.45.00
TemplateLevel=006
SubScriptsLevel=010
SubScriptsVersion=04.45.00
SubScriptTemplateVersion=04.45.00
#
...
if ${SCRIPTVERBOSE} ; then
    ...
    echo 'Subscript Name:  '${SubScriptName}'  Subcript Version: '${SubScriptVersion}'  Subscript Revision:  '${SubScriptRevision}'  Level:  '${SubScriptsLevel}'  Template Version: '${TemplateVersion} | tee -a -i ${logfilepath}
