...
export conffilespathETC=${conffilespathroot}/etc
...
echo 'conffilespathETC                       ='"${conffilespathETC}" | tee -a -i ${logfilepath}
echo '----------------------------------------------------------------------------' >> ${logfilepath}
...
if [ ! -r ${conffilespathETC} ] ; then
    mkdir -pv ${conffilespathETC} >> ${logfilepath} 2>&1
    chmod 775 ${conffilespathETC} >> ${logfilepath} 2>&1
else
    #set permissions we need
    chmod 775 ${conffilespathETC} >> ${logfilepath} 2>&1
fi
    ...
    #cp "${file2copypathfqfp}" ${conffilespathETC} &>> ${outputfilefqfn}
#fi
...
#----------------------------------------------------------------------------------------
# bash - collect dhcp related files
#----------------------------------------------------------------------------------------
...
export file2copy=dhclient.conf
export file2copypathfqfp="/etc/${file2copy}"

export command2folder=dhcp
export outputfilenameaddon=
...
export file2copy=dhclient6.conf
export file2copypathfqfp="/etc/${file2copy}"
...
export file2copy=dhclient-enter-hooks
export file2copypathfqfp="/etc/dhcp/${file2copy}"
...
if [ ! -r ${conffilespathETC}/dhcp ] ; then
    mkdir -pv ${conffilespathETC}/dhcp >> ${logfilepath} 2>&1
    chmod 775 ${conffilespathETC}/dhcp >> ${logfilepath} 2>&1
else
    #set permissions we need
    chmod 775 ${conffilespathETC}/dhcp >> ${logfilepath} 2>&1
fi
...
if [ -r ${file2copypathfqfp} ] ; then
    cp ${file2copypathfqfp} ${conffilespathETC}/dhcp/ &>> ${outputfilefqfn}
    cp ${file2copypathfqfp}* ${conffilespathETC}/dhcp/ &>> ${outputfilefqfn}
fi
