...
#
# SCRIPT Template for bash scripts subscripts or action scripts - Config Caputure Details Action Script - hardware
#
#
...
SubScriptFileNameRoot=config_details_capture.action_script.hardware
SubScriptShortName="config_details_capture.hardware.${SubScriptsLevel}"
SubScriptDescription="Template for bash scripts subscripts or action scripts - Config Caputure Details Action Script - hardware"
