...
CopyFileAndDump2FQDNOutputfile () {
    ...
    if [ ! -r ${outputfilefqdn} ] ; then
        mkdir -pv ${outputfilefqdn} | tee -a -i ${logfilepath}
        chmod 775 ${outputfilefqdn} | tee -a -i ${logfilepath}
    else
        chmod 775 ${outputfilefqdn} | tee -a -i ${logfilepath}
    fi
...
if [ ! -r ${conffilespathFWDIRbootmodules} ] ; then
    mkdir -pv ${conffilespathFWDIRbootmodules} | tee -a -i ${logfilepath}
    chmod 775 ${conffilespathFWDIRbootmodules} | tee -a -i ${logfilepath}
else
    #set permissions we need
    chmod 775 ${conffilespathFWDIRbootmodules} | tee -a -i ${logfilepath}
fi
...
if [ ! -r ${conffilespathPPKDIRbootmodules} ] ; then
    mkdir -pv ${conffilespathPPKDIRbootmodules} | tee -a -i ${logfilepath}
    chmod 775 ${conffilespathPPKDIRbootmodules} | tee -a -i ${logfilepath}
else
    #set permissions we need
    chmod 775 ${conffilespathPPKDIRbootmodules} | tee -a -i ${logfilepath}
fi
...
if [ ! -r ${conffilespathPPKDIRconf} ] ; then
    mkdir -pv ${conffilespathPPKDIRconf} | tee -a -i ${logfilepath}
    chmod 775 ${conffilespathPPKDIRconf} | tee -a -i ${logfilepath}
else
    #set permissions we need
    chmod 775 ${conffilespathPPKDIRconf} | tee -a -i ${logfilepath}
fi
...
if [ ! -r ${conffilespathFWDIRconf} ] ; then
    mkdir -pv ${conffilespathFWDIRconf} | tee -a -i ${logfilepath}
    chmod 775 ${conffilespathFWDIRconf} | tee -a -i ${logfilepath}
else
    #set permissions we need
    chmod 775 ${conffilespathFWDIRconf} | tee -a -i ${logfilepath}
fi
...
if [ ! -r ${conffilespathFWDIRdatabase} ] ; then
    mkdir -pv ${conffilespathFWDIRdatabase} | tee -a -i ${logfilepath}
    chmod 775 ${conffilespathFWDIRdatabase} | tee -a -i ${logfilepath}
else
    #set permissions we need
    chmod 775 ${conffilespathFWDIRdatabase} | tee -a -i ${logfilepath}
fi
...
if ${IsR8XVersion}; then
    ...
    if [[ ${sys_type_SMS} = 'true' ]] || [[ ${sys_type_SmartEvent} = 'true' ]] ||  [[ ${sys_type_MDS} = 'true' ]]; then
        ...
        mgmt_cli -r true show version --port ${currentapisslport} >> ${outputfilefqfn}
        errorresult=$?
...
export archivefilename=${HOSTNAME}'_'${targetversion}'_'${BASHScriptName}.${DATEDTGS}${archivefiletype}
