...
export command2folder=CPUSE_and_Upgrade_Tools
...
DoCommandAndDocument tail -n 30 /opt/CPInstLog/DA_Actions.xml

DoCommandAndDocument tail -n 30 /opt/CPInstLog/DA_Actions_Messages.json
