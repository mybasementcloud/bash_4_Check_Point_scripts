...
#
# SCRIPT Template for bash scripts subscripts or action scripts - Config Caputure Details Action Script - user_environment
#
#
...
SubScriptFileNameRoot=config_details_capture.action_script.user_environment
SubScriptShortName="config_details_capture.user_environment.${SubScriptsLevel}"
SubScriptDescription="Template for bash scripts subscripts or action scripts - Config Caputure Details Action Script - user_environment"
...
export command2run=clish_history
export outputfile=${outputfileprefix}'_'${command2run}${outputfilesuffix}${outputfiletype}
if [ -z ${command2folder} ] ; then
    export outputfilefqdn=${outputfilepath}
    export outputfilefqfn=${outputfilepath}${outputfile}
...
echo 'clish history :' >> ${outputfilefqfn}
echo >> ${outputfilefqfn}
echo '----------------------------------------------------------------------------' >> ${outputfilefqfn}
echo >> ${outputfilefqfn}
...
clish -c "history" >> ${outputfilefqfn}
echo >> ${outputfilefqfn}
