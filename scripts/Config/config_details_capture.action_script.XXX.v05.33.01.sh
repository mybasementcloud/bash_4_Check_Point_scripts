...
#
# SCRIPT Template for bash scripts subscripts or action scripts - Config Caputure Details Action Script - XXX
#
#
...
SubScriptFileNameRoot=config_details_capture.action_script.XXX
SubScriptShortName="config_details_capture.XXX.${SubScriptsLevel}"
SubScriptDescription="Template for bash scripts subscripts or action scripts - Config Caputure Details Action Script - XXX"
