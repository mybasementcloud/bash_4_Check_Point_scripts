...
if $IsMigrateWIndexes ; then
    ...
    #export command2run='export -n -x 30'
    export command2run='export -n -x 30 --include-uepm-msi-files'
    #export command2run='export -n'
else
    # Migrate does not supports export of indexes
    #export command2run='export -n -l 30'
    export command2run='export -n -l 30 --include-uepm-msi-files'
    #export command2run='export -n'
fi
...
if $IsMigrateWIndexes ; then
    # Migrate supports export of indexes
    #export command2run2='export -n -x 30 --include-uepm-msi-files'
    export command2run2='export -n -x 30'
    #export command2run2='export -n --include-uepm-msi-files'
else
    # Migrate does not supports export of indexes
    #export command2run2='export -n -l 30 --include-uepm-msi-files'
    export command2run2='export -n -l 30'
    #export command2run2='export -n --include-uepm-msi-files'
fi
