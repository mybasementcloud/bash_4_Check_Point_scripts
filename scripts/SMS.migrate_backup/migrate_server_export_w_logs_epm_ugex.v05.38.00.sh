...
case "${toolsversion}" in
    R82 | R82.10 | R82.20 ) 
        #/opt/CPsuite-R82/fw1/scripts/migrate_server
        #/opt/CPupgrade-tools-R82/scripts/migrate_server
        #/opt/CPsuite-R82.10/fw1/scripts/migrate_server
        #/opt/CPupgrade-tools-R82.10/scripts/migrate_server
        #/opt/CPsuite-R82.20/fw1/scripts/migrate_server
        #/opt/CPupgrade-tools-R82.20/scripts/migrate_server
