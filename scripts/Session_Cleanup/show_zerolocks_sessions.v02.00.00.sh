...
export APIScriptVersion=v02x00x00
export APIScriptTemplateVersion=v00x32x00
export APICommonScriptsVersion=v00x32x00
...
export cli_api_cmdlineparm_handler_file=cmd_line_parameters_handler.action.common.005.v$CommonScriptsVersion.sh
...
export gaia_version_handler_file=identify_gaia_and_installation.action.common.005.v$CommonScriptsVersion.sh
...
ConfigureLogPath () {
    ...
    if [ -z "$CLIparm_logpath" ]; then
        ...
        export APICLIlogfilepathfinal=$APICLIlogpathbase/$ScriptName'_'$APIScriptVersion'_'$DATEDTGS.log
    else
        ...
        export APICLIlogfilepathfinal=$expandedpath
    fi
...
echo | tee -a -i $APICLIlogfilepath
echo 'Show zero locks sessions' | tee -a -i $APICLIlogfilepath
echo | tee -a -i $APICLIlogfilepath
