...
export APIScriptFileNameRoot=show_zerolocks_web_api_sessions
export APIScriptShortName=show_zerolocks_web_api_sessions
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Show zerolocks sessions with web_api user"
