...
export APIScriptFileNameRoot=remove_zerolocks_sessions
export APIScriptShortName=remove_zerolocks_sessions
export APIScriptnohupName=${APIScriptShortName}
export APIScriptDescription="Remove zerolocks sessions all users"
...
export MaxMaaSAPIVersion=2.0.1
