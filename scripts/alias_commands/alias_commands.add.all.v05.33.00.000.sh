...
alias generate_script_links='cd ${MYWORKFOLDERUGEX};${MYWORKFOLDERUGEXSCRIPTS}/generate_script_links.v05.33.00.sh'
alias remove_script_links='cd ${MYWORKFOLDERUGEX};${MYWORKFOLDERUGEXSCRIPTS}/remove_script_links.v05.33.00.sh'
alias reset_script_links='cd ${MYWORKFOLDERUGEX};${MYWORKFOLDERUGEXSCRIPTS}/remove_script_links.v05.33.00.sh;echo;${MYWORKFOLDERUGEXSCRIPTS}/generate_script_links.v05.33.00.sh;echo;list'
...
alias make_local_snapshot_and_backup='cd ${MYWORKFOLDERUGEX};${MYWORKFOLDERUGEXSCRIPTS}/Common/make_local_snapshot_and_backup.v05.33.00.sh'
printf "${tCYAN}%-35s${tNORM} : %s\n" "make_local_snapshot_and_backup" 'Make local Gaia Snapshot and Backup' >> ${tempENVHELPFILEalias}
alias make_snapshot_and_backup_to_ftp='cd ${MYWORKFOLDERUGEX};${MYWORKFOLDERUGEXSCRIPTS}/Common/make_snapshot_and_backup_to_ftp_target.v05.33.00.sh'
...
alias alias_commands_add_user='cd ${MYWORKFOLDERUGEX};${MYWORKFOLDERUGEXSCRIPTS}/UserConfig/alias_commands_add_user.v05.33.00.sh'
alias alias_commands_add_all_users='cd ${MYWORKFOLDERUGEX};${MYWORKFOLDERUGEXSCRIPTS}/UserConfig/alias_commands_add_all_users.v05.33.00.sh'
...
alias alias_commands_update_user='cd ${MYWORKFOLDERUGEX};${MYWORKFOLDERUGEXSCRIPTS}/UserConfig/alias_commands_update_user.v05.33.00.sh'
alias alias_commands_update_all_users='cd ${MYWORKFOLDERUGEX};${MYWORKFOLDERUGEXSCRIPTS}/UserConfig/alias_commands_update_all_users.v05.33.00.sh'
...
alias reset_all_users_home_profile_files='cd ${MYWORKFOLDERUGEX};${MYWORKFOLDERUGEXSCRIPTS}/UserConfig/reset_all_users_home_profile_files.v05.33.00.sh'
