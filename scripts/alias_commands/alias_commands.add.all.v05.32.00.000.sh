...
# 2022-03-24
alias collect_core_dumps_now='WORKNOWFOLDER="${MYWORKFOLDERDUMP}/`date +%Y`/`DTGSDATE`_core_dumps";mkdir -pv "${WORKNOWFOLDER}";list "${MYWORKFOLDERDUMP}/";echo;cd "${WORKNOWFOLDER}";echo;echo Current path = `pwd`;echo;echo "Core dumps:  /var/log/dump/usermode/";echo;ls -alh --color=auto /var/log/dump/usermode/;echo;echo "Copy core dump *.gz files to this folder";echo;cp /var/log/dump/usermode/*.gz .;echo;ls -alh --color=auto .;echo'
...
alias collect_cpview_periodic_export='WORKNOWFOLDER="${MYWORKFOLDERDUMP}/`date +%Y`/`DTGSDATE`_cpview_periodic_export";mkdir -pv "${WORKNOWFOLDER}";list "${MYWORKFOLDERDUMP}/";echo;cd "${WORKNOWFOLDER}";echo;;cpview -p | ${JQ} -s . > cpview_data_`DTGSDATE`.json;echo;ls -alh --color=auto .;echo;echo Current path = `pwd`;echo'
printf "${tCYAN}%-35s${tNORM} : %s\n" "collect_cpview_periodic_export" 'Generate cpview -p output to Dump folder now with DTGSDATE' >> ${tempENVHELPFILEalias}

alias collect_cpview_export='WORKNOWFOLDER="${MYWORKFOLDERDUMP}/`date +%Y`/`DTGSDATE`_cpview_export";mkdir -pv "${WORKNOWFOLDER}";list "${WORKNOWFOLDER}/";echo;cpview -s export;read lastfilefound < <(ls -t /var/log/cpview_export/*.gz);echo "Last File Found ="${lastfilefound}; cp ${lastfilefound} ${WORKNOWFOLDER}/;echo;echo;ls -alh --color=auto ${WORKNOWFOLDER};echo;echo Current path = `pwd`;echo'
...
alias generate_script_links='cd ${MYWORKFOLDERUGEX};${MYWORKFOLDERUGEXSCRIPTS}/generate_script_links.v05.32.00.sh'
alias remove_script_links='cd ${MYWORKFOLDERUGEX};${MYWORKFOLDERUGEXSCRIPTS}/remove_script_links.v05.32.00.sh'
alias reset_script_links='cd ${MYWORKFOLDERUGEX};${MYWORKFOLDERUGEXSCRIPTS}/remove_script_links.v05.32.00.sh;echo;${MYWORKFOLDERUGEXSCRIPTS}/generate_script_links.v05.32.00.sh;echo;list'
...
alias make_local_snapshot_and_backup='cd ${MYWORKFOLDERUGEX};${MYWORKFOLDERUGEXSCRIPTS}/Common/make_local_snapshot_and_backup.v05.32.00.sh'
printf "${tCYAN}%-35s${tNORM} : %s\n" "make_local_snapshot_and_backup" 'Make local Gaia Snapshot and Backup' >> ${tempENVHELPFILEalias}
alias make_snapshot_and_backup_to_ftp='cd ${MYWORKFOLDERUGEX};${MYWORKFOLDERUGEXSCRIPTS}/Common/make_snapshot_and_backup_to_ftp_target.v05.32.00.sh'
...
alias alias_commands_add_user='cd ${MYWORKFOLDERUGEX};${MYWORKFOLDERUGEXSCRIPTS}/UserConfig/alias_commands_add_user.v05.32.00.sh'
alias alias_commands_add_all_users='cd ${MYWORKFOLDERUGEX};${MYWORKFOLDERUGEXSCRIPTS}/UserConfig/alias_commands_add_all_users.v05.32.00.sh'
...
alias alias_commands_update_user='cd ${MYWORKFOLDERUGEX};${MYWORKFOLDERUGEXSCRIPTS}/UserConfig/alias_commands_update_user.v05.32.00.sh'
alias alias_commands_update_all_users='cd ${MYWORKFOLDERUGEX};${MYWORKFOLDERUGEXSCRIPTS}/UserConfig/alias_commands_update_all_users.v05.32.00.sh'
...
alias reset_all_users_home_profile_files='cd ${MYWORKFOLDERUGEX};${MYWORKFOLDERUGEXSCRIPTS}/UserConfig/reset_all_users_home_profile_files.v05.32.00.sh'
