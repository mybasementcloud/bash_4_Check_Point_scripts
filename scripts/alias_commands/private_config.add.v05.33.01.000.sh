...
echo ${tGREEN}' Scripts :  Version '${tYELLOW}${ScriptVersion}${tGREEN}', Revision '${tYELLOW}${ScriptRevision}${tGREEN}', Level '${tYELLOW}${AliasCommandsLevel}${tGREEN}' from Date '${tYELLOW}${ScriptDate}${tDEFAULT}
echo ${tGREEN}'==============================================================================='${tDEFAULT}
echo
