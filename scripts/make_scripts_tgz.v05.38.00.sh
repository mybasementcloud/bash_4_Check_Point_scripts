...
#
# SCRIPT:  Make scripts tgz file for this version and using relevant date and version information
#
#
# Version created 2026-MM-DD-HHMM hrs TZN
# Version created 2026-02-08-1745 hrs CST
#ScriptDTG=2026-MM-DD-HHMM
ScriptDTG=2026-02-08-1745
ScriptTZ=CST
...
export BASHScriptFileNameRoot=make_scripts_tgz
export BASHScriptShortName=make_scripts_tgz.v${ScriptVersion}
export BASHScriptnohupName=${BASHScriptShortName}
export BASHScriptDescription="Make scripts tgz file for this version and using relevant date and version information"
...
export workpathbase=${customerworkpathroot}
export workstartfolder=scripts
export workpathfqpn=${workpathbase}/${workstartfolder}
...
echo | tee -a -i ${logfilepath}
echo 'Lets do some housecleaning...' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}

export targetfolderfqpn=${workpathfqpn}/_SYNCAPP
if [ -r ${targetfolderfqpn} ] ; then
    echo 'Need to remove folder:  "'${targetfolderfqpn}'"' | tee -a -i ${logfilepath}
    
    rm -f -r -d -v ${targetfolderfqpn} | tee -a -i ${logfilepath}
    
fi

export targetfolderfqpn=${workpathfqpn}/__history
if [ -r ${targetfolderfqpn} ] ; then
    echo 'Need to remove folder:  "'${targetfolderfqpn}'"' | tee -a -i ${logfilepath}
...
#export targetfolderfqpn=${workpathfqpn}/__Windows.CMD
#if [ -r ${targetfolderfqpn} ] ; then
    #echo 'Need to remove folder:  "'${targetfolderfqpn}'"' | tee -a -i ${logfilepath}
...
#export targetfolderfqpn=${workpathfqpn}/*.CMD
#if [ -r ${targetfolderfqpn} ] ; then
    #echo 'Need to remove folder:  "'${targetfolderfqpn}'"' | tee -a -i ${logfilepath}
...
#----------------------------------------------------------------------------------------
# Generate Archive of scripts folder
#----------------------------------------------------------------------------------------


export archivepathbase=${customerworkpathroot}
export archivestartfolder=scripts
export archivefilename=b4CP.${archivestartfolder}.${BASHScriptVersion}.${ScriptRevision}.${ScriptSubRevision}.${ScriptDTGTZ}.tgz
...
echo '----------------------------------------------------------------------------' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}
echo 'Archive '${archivestartfolder}' folder' | tee -a -i ${logfilepath}
...
#----------------------------------------------------------------------------------------
# Generate Copy of Archive from above without version details
#----------------------------------------------------------------------------------------


export archivecopyfilename=${archivestartfolder}.tgz
export archivecopyfqfn=${archivepathbase}/${archivecopyfilename}
...
echo '----------------------------------------------------------------------------' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}
echo 'Copy Archive file' | tee -a -i ${logfilepath}
echo ' - from '${archivefqfn} | tee -a -i ${logfilepath}
echo ' - to : '${archivecopyfqfn} | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}
echo '----------------------------------------------------------------------------' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}

cp ${archivefqfn} ${archivecopyfqfn} | tee -a -i ${logfilepath}
...
echo | tee -a -i ${logfilepath}
echo 'List folder : '${archivepathbase}' tgz files' | tee -a -i ${logfilepath}
ls -alh ${archivepathbase}/*.tgz | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}
...
echo | tee -a -i ${logfilepath}
echo 'Output location for all results is here : '${archivepathbase} | tee -a -i ${logfilepath}
echo 'Log results documented in this log file : '${logfilepath} | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}
...
echo | tee -a -i ${logfilepath}
echo 'Script '${BASHScriptFileNameRoot}' Completed, exiting...' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}
