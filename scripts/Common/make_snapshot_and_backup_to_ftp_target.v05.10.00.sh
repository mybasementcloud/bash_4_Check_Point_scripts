...
ScriptVersion=05.10.00
ScriptRevision=000
TemplateVersion=05.10.00
TemplateLevel=006
SubScriptsLevel=010
SubScriptsVersion=05.10.00
#
...
export ccommand="'show snapshots'"
export wcommand="echo ; echo ; echo 'CTRL-C when snapshot "${snapshotname}" is visible in list' ; echo ; clish -c "${ccommand}
