...
#
# SCRIPT Make Gaia snapshot and Gaia backup to ftp target folder
#
#
...
export BASHScriptFileNameRoot=make_snapshot_and_backup_to_ftp_target
export BASHScriptShortName=snapshot_and_backup_to_ftp
export BASHScriptnohupName=${BASHScriptShortName}
export BASHScriptDescription="Make Gaia snapshot and Gaia backup to ftp target folder"
