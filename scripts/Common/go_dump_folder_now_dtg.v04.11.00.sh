...
export BASHScriptName="go_dump_folder_now_dtg.v$ScriptVersion"
export BASHScriptShortName="go_dump_folder_now_dtg"
export BASHScriptDescription="Gnerate a dump folder based on the current time and date and go there"
