...
#
#
ScriptDate=2021-04-14
ScriptVersion=05.11.00
ScriptRevision=000
TemplateVersion=05.11.00
TemplateLevel=006
SubScriptsLevel=010
SubScriptsVersion=05.11.00
#
...
case "${gaiaversion}" in
    ...
    R81.10 ) 
        ...
        ;;
    *)
        export snapshotnameversion=XXxXX
        ;;
esac
...
#
#export ccommand="add snapshot ${snapshotname} description '"${snapshotdescription}"'"
#
...
export ccommand="'show snapshots'"
export wcommand="echo ; echo ; echo 'CTRL-C when snapshot "${snapshotname}" activity is no longer visible' ; echo ; clish -c "${ccommand}
