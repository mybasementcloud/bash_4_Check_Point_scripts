...
if $OutputDTGTZinUTC ; then
    #export logfilepath=${logfilefolder}/${BASHScriptName}.${HOSTNAME}.${gaia_version}.${DATEUTCDTGS}.log
    export logfilepath=${logfilefolder}/${BASHScriptName}.${DATEUTCDTGS}.log
else
    #export logfilepath=${logfilefolder}/${BASHScriptName}.${HOSTNAME}.${gaia_version}.${DATEDTGS}.log
...
#export script2nohupstdoutlog=.nohup.$nohupDTGS.${script2nohupfile}.stdout.txt
#export script2nohupstderrlog=.nohup.$nohupDTGS.${script2nohupfile}.stderr.txt
#export script2watchnohupwork=.nohup.$nohupDTGS.${script2nohupfile}.watchme.sh
#export script2watchdiskspace=.nohup.$nohupDTGS.${script2nohupfile}.diskspace.sh
#export script2cleannohupwork=.nohup.$nohupDTGS.${script2nohupfile}.cleanup.sh
#export script2logdisklv_log=.nohup.$nohupDTGS.${script2nohupfile}.diskspace.vg_splat-lv_log.sh
#export script2logdisklvcrnt=.nohup.$nohupDTGS.${script2nohupfile}.diskspace.vg_splat-lv_current.sh
...
echo | tee -a -i ${logfilepath}
echo 'nohup "'$@'" --NOWAIT --NOHUP --NOHUP-Script="'${script2nohupfile}'" --NOHUP-DTG="'$nohupDTG'" 2>> '${script2nohupstderrlog}' >> '${script2nohupstdoutlog}' &' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}

#nohup ${script2nohup} >> ${script2nohupstdoutlog} 2>> ${script2nohupstderrlog}
nohup "$@" --NOWAIT --NOHUP --NOHUP-Script="${script2nohupfile}" --NOHUP-DTG="$nohupDTG" 2>> ${script2nohupstderrlog} >> ${script2nohupstdoutlog} &

echo | tee -a -i ${logfilepath}
echo Log file : ${logfilepath} | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}

echo 'Allow the script a moment to get running...'
echo
sleep 10
...
#ls -alh .nohup.$nohupDTGS.${script2nohupfile}.* | tee -a -i ${logfilepath}
