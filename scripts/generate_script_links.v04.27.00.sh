...
CopyToB4CPScriptsAndLink () {
    ...
    ln -sf $repositoryfileFQFP $targetFQPN/$scriptaliasname
...
LinkInB4CPScripts () {
    ...
    ln -sf $fileFQFP $targetFQPN/$scriptaliasname
...
file_root_001=generate_script_links.v04.27.00.sh
file_root_002=remove_script_links.v04.27.00.sh
...
# =============================================================================
# =============================================================================
# FOLDER:  Scripts _sub-scripts
# =============================================================================

#
# Handle the scripts _sub-scripts folder
#
subscripts_folder=_sub-scripts
source_subscripts_folder=$workingbase/$subscripts_folder
target_subscripts_folder=$scriptsrepository/$subscripts_folder
...
file_common_001=determine_gaia_version_and_installation_type.v04.27.00.sh
file_common_002=do_script_nohup.v04.27.00.sh

file_common_003=go_dump_folder_now.v04.27.00.sh
file_common_004=go_dump_folder_now_dtg.v04.27.00.sh
file_common_005=go_change_log_folder_now_dtg.v04.27.00.sh

file_common_006=make_dump_folder_now.v04.27.00.sh
file_common_007=make_dump_folder_now_dtg.v04.27.00.sh
...
file_config_001=config_capture.v04.27.00.sh
file_config_002=show_interface_information.v04.27.00.sh
file_config_003=EPM_config_check.v04.27.00.sh
...
file_GW_001=watch_accel_stats.v04.27.00.sh
file_GW_002=set_informative_logging_implied_rules_on_R8x.v04.27.00.sh
file_GW_003=reset_hit_count_with_backup.v04.27.00.sh
file_GW_004=show_clusterXL_information.v04.27.00.sh
file_GW_005=watch_cluster_status.v04.27.00.sh
file_GW_006=enable_rad_admin_stats.v00.01.00.sh
file_GW_007=vpn_client_operational_info.v04.27.00.sh
file_GW_008=vpn_client_operational_info.standalone.v04.27.00.sh
file_GW_009=fix_gw_missing_updatable_objects.v04.27.00.sh
...
ln -sf $sourcefolder/$file_GW_004 $linksfolder/show_cluster_info
...
if [ "$sys_type_GW" == "true" ]; then
    ...
    if [[ $(cpconfig <<< 10 | grep cluster) == *"Disable"* ]]; then
        ...
        # These have been replaced with alias commands or alias links
        #
        #ln -sf $sourcefolder/$file_GW_004 $workingroot/show_cluster_info
...
if [ ! -r $sourcefolder ] ; then
    ...
    file_GW_CORE_001=fix_smcias_interfaces.v04.27.00.sh
    file_GW_CORE_002=set_fwkern_dot_conf_settings_on_R8x.CORE.v04.27.00.sh
...
file_healthcheck_002=run_healthcheck_to_dump_dtg.v04.27.00.sh
file_healthcheck_003=check_status_checkpoint_services.v04.27.00.sh
...
file_MDM_001=backup_mds_ugex.v04.27.00.sh
file_MDM_002=backup_mds_w_logs_ugex.v04.27.00.sh

file_MDM_003=report_mdsstat.v04.27.00.sh
file_MDM_004=watch_mdsstat.v04.27.00.sh
file_MDM_005=show_all_domains_in_array.v04.27.00.sh
...
if [ "$sys_type_MDS" == "true" ]; then
    ...
    CopyToB4CPScriptsAndLink $sourcefolder/$file_MDM_005 $scriptsbase $scriptsrepository show_domains_in_array
...
file_MGMT_003=check_status_of_scheduled_ips_updates_on_management.v04.27.00.sh
...
ln -sf $sourcefolder/$file_MGMT_003 $linksfolder/check_status_of_scheduled_ips_updates_on_management
...
#ln -sf $sourcefolder/$file_MGMT_003 $workingroot/check_status_of_scheduled_ips_updates_on_management

CopyToB4CPScriptsAndLink $sourcefolder/$file_MGMT_001 $scriptsbase $scriptsrepository identify_self_referencing_symbolic_link_files
#CopyToB4CPScriptsAndLink $sourcefolder/$file_MGMT_002 $scriptsbase $scriptsrepository Lite.identify_self_referencing_symbolic_link_files
CopyToB4CPScriptsAndLink $sourcefolder/$file_MGMT_003 $scriptsbase $scriptsrepository check_status_of_scheduled_ips_updates_on_management
...
file_SMEV_001=SmartEvent_Backup_R8X.v04.27.00.sh
file_SMEV_002=SmartEvent_Restore_R8X.v04.26.00-NR.sh
file_SMEV_003=Reset_SmartLog_Indexing_Back_X_Days.v04.27.00.sh
file_SMEV_004=NUKE_ALL_LOGS_AND_INDEXES.v04.27.00.sh
...
if [ "$sys_type_SmartEvent" == "true" ]; then
    ...
    CopyToB4CPScriptsAndLink $sourcefolder/$file_SMEV_001 $scriptsbase $scriptsrepository SmartEvent_backup
    #CopyToB4CPScriptsAndLink $sourcefolder/$file_SMEV_002 $scriptsbase $scriptsrepository SmartEvent_restore
    #CopyToB4CPScriptsAndLink $sourcefolder/$file_SMEV_003 $scriptsbase $scriptsrepository Reset_SmartLog_Indexing
    #CopyToB4CPScriptsAndLink $sourcefolder/$file_SMEV_004 $scriptsbase $scriptsrepository SmartEvent_NUKE_Index_and_Logs
fi
...
file_SMS_005=report_cpwd_admin_list.v04.27.00.sh
file_SMS_006=watch_cpwd_admin_list.v04.27.00.sh
file_SMS_007=restart_mgmt.v04.27.00.sh

file_SMS_008=fix_api_memory.v04.27.00.sh
...
file_SMS_CORE_001=CORE-G2_install_policy.v04.27.00.raw.sh
...
file_SMS_Migrate_001=migrate_export_npm_ugex.v04.27.00.sh
file_SMS_Migrate_002=migrate_export_w_logs_npm_ugex.v04.27.00.sh
file_SMS_Migrate_003=migrate_export_epm_ugex.v04.27.00.sh
file_SMS_Migrate_004=migrate_export_w_logs_epm_ugex.v04.27.00.sh

file_SMS_Migrate_011=migrate_server_export_npm_ugex.v04.27.00.sh
file_SMS_Migrate_012=migrate_server_export_w_logs_npm_ugex.v04.27.00.sh
file_SMS_Migrate_013=migrate_server_export_epm_ugex.v04.27.00.sh
file_SMS_Migrate_014=migrate_server_export_w_logs_epm_ugex.v04.27.00.sh
...
file_USERCONF_001=add_alias_commands.all.v04.27.00.sh
file_USERCONF_002=add_alias_commands_all_users.all.v04.27.00.sh
file_USERCONF_003=update_alias_commands.all.v04.27.00.sh
file_USERCONF_004=update_alias_commands_all_users.all.v04.27.00.sh
...
if [ ! -r $sourcefolder ] ; then
    ...
    file_USERCONF_005=add_alias_commands.CORE_G2.NPM.v04.27.00.sh
    file_USERCONF_006=add_alias_commands_all_users.CORE_G2.NPM.v04.27.00.sh
    file_USERCONF_007=update_alias_commands.CORE_G2.NPM.v04.27.00.sh
    file_USERCONF_008=update_alias_commands_all_users.CORE_G2.NPM.v04.27.00.sh
    ...
    #LinkInB4CPScripts $sourcefolder/$file_USERCONF_005 $scriptsbase alias_commands_CORE_G2_NPM_add_user
    #LinkInB4CPScripts $sourcefolder/$file_USERCONF_006 $scriptsbase alias_commands_CORE_G2_NPM_add_all_users
    #LinkInB4CPScripts $sourcefolder/$file_USERCONF_007 $scriptsbase alias_commands_CORE_G2_NPM_update_user
    #LinkInB4CPScripts $sourcefolder/$file_USERCONF_008 $scriptsbase alias_commands_CORE_G2_NPM_update_all_users
    
    #CopyToB4CPScriptsAndLink $sourcefolder/$file_USERCONF_005 $scriptsbase $scriptsrepository alias_commands_CORE_G2_NPM_add_user
    #CopyToB4CPScriptsAndLink $sourcefolder/$file_USERCONF_006 $scriptsbase $scriptsrepository alias_commands_CORE_G2_NPM_add_all_users
    #CopyToB4CPScriptsAndLink $sourcefolder/$file_USERCONF_007 $scriptsbase $scriptsrepository alias_commands_CORE_G2_NPM_update_user
    #CopyToB4CPScriptsAndLink $sourcefolder/$file_USERCONF_008 $scriptsbase $scriptsrepository alias_commands_CORE_G2_NPM_update_all_users
    
    #
    # Handle the UserConfig alias_commands[.x] folder
    #
    #alias_commands_folder=alias_commands.CORE_G2.NPM
    #source_alias_commands_folder=$workingbase/$alias_commands_folder
    #target_alias_commands_folder=$scriptsrepository/$alias_commands_folder
