...
#
#
ScriptDate=2020-06-10
ScriptVersion=04.27.01
ScriptRevision=000
...
export folderstdversion=v04.27.00
...
export subscriptsstdversion=v04.08.00
...
export folderstdversion=v04.27.01
export sourcefolder=$workingbase/$workingdir
export linksfolder=$linksbase/$workingdir
if [ ! -r $linksfolder ] ; then
    mkdir -pv $linksfolder | tee -a -i $logfilepath
...
export folderstdversion=v04.00.00
export sourcefolder=$workingbase/$workingdir
export linksfolder=$linksbase/$workingdir
if [ ! -r $linksfolder ] ; then
    mkdir -pv $linksfolder | tee -a -i $logfilepath
