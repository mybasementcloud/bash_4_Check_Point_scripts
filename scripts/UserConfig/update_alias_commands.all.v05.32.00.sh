...
echo | tee -a "${outputfilefqdn}"
echo '===============================================================================' | tee -a "${outputfilefqdn}"
echo "Updating alias commands from ${alliasAddFilefqfp} to users ${HOME} folder" | tee -a "${outputfilefqdn}"
echo | tee -a "${outputfilefqdn}"
...
echo '===============================================================================' | tee -a "${outputfilefqdn}"
echo | tee -a "${outputfilefqdn}"
echo "Updating alias commands from ${alliasAddFilefqfp} to users ${HOME}/.bashrc file" | tee -a "${outputfilefqdn}"
echo | tee -a "${outputfilefqdn}"
