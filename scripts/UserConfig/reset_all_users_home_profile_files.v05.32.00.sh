...
#
# SCRIPT Reset all users home profile files in /home folders
#
...
export BASHScriptFileNameRoot=reset_all_users_home_profile_files
export BASHScriptShortName="reset_all_users_home_profile_files"
export BASHScriptnohupName=${BASHScriptShortName}
export BASHScriptDescription="Reset all users home profile files in /home folders"
...
#==================================================================================================
#
# START :  Reset user home profile files
#
#==================================================================================================
#==================================================================================================
...
export originalprofilefilesfqpn=/etc/skel
...
do
    ...
    echo >> "${outputfilefqdn}"
    echo '-------------------------------------------------------------------------------' >> "${outputfilefqdn}"
    echo "Clean files from folder ${workfolder}" | tee -a "${outputfilefqdn}"
    echo | tee -a "${outputfilefqdn}"
    
    rm -f -v ${workfolder}/alias_commands*.sh >> "${outputfilefqdn}" 2>&1
    rm -f -v ${workfolder}/private_config*.sh >> "${outputfilefqdn}" 2>&1
    if [ -f ${workfolder}/${dotbashalliasestargetfile} ] ; then
        cp ${workfolder}/${dotbashalliasestargetfile} ${workfolder}/${dotbashalliasestargetfile}.${DATEDTGS}.bak >> "${outputfilefqdn}" 2>&1
    fi
    rm -f -v ${workfolder}/alias_commands_for_dot_bashrc*.sh >> "${outputfilefqdn}" 2>&1
    
    echo >> "${outputfilefqdn}"
    echo '-------------------------------------------------------------------------------' >> "${outputfilefqdn}"
    echo "Replace with files from folder ${originalprofilefilesfqpn}" | tee -a "${outputfilefqdn}"
    echo | tee -a "${outputfilefqdn}"
    
    cp -fv ${originalprofilefilesfqpn}/.bash_logout ${workfolder}/ >> "${outputfilefqdn}" 2>&1
    cp -fv ${originalprofilefilesfqpn}/.bash_profile ${workfolder}/ >> "${outputfilefqdn}" 2>&1
    cp -fv ${originalprofilefilesfqpn}/.bashrc ${workfolder}/ >> "${outputfilefqdn}" 2>&1
    ...
    echo >> "${outputfilefqdn}"
    echo '===============================================================================' >> "${outputfilefqdn}"
    echo "Files in ${workfolder}" >> "${outputfilefqdn}"
    echo >> "${outputfilefqdn}"
    
    ls -alh ${workfolder} >> "${outputfilefqdn}"
...
#==================================================================================================
#
# END :  Reset user home profile files
#
#==================================================================================================
#==================================================================================================
