...
echo | tee -a "$outputfilefqdn"
echo '===============================================================================' | tee -a "$outputfilefqdn"
echo "Adding alias commands from $alliasAddFilefqfp to all user's $HOME folder" | tee -a "$outputfilefqdn"
echo | tee -a "$outputfilefqdn"
...
do
    ...
    if [ "$workfolder" != "/home/adminscp" ]; then
        ...
        cp $alliasAddFilefqfp $workfolder/ | tee -a "$outputfilefqdn"
        
        echo "Copy $dotbashrcmodfilefqfp to $workfolder" | tee -a "$outputfilefqdn"
        echo | tee -a "$outputfilefqdn"
        cp $dotbashrcmodfilefqfp $workfolder/ | tee -a "$outputfilefqdn"
        ...
        if [ $checkifaddalliasappended -eq 1 ] ; then
            ...
            cat $dotbashrcmodfilefqfp >> $i | tee -a "$outputfilefqdn"
