...
echo | tee -a "${outputfilefqdn}"
echo '===============================================================================' | tee -a "${outputfilefqdn}"
echo "Adding alias commands from ${alliasAddFilefqfp} to users ${HOME} folder" | tee -a "${outputfilefqdn}"
echo | tee -a "${outputfilefqdn}"
...
rm -f -v ${HOME}/alias_commands*.sh >> "${outputfilefqdn}" 2>&1
cp ${alliasAddFilefqfp} ${HOME}/ >> "${outputfilefqdn}" 2>&1

if [ -f ${PrivateConfigAddFilefqfp} ] ; then
    rm -f -v ${HOME}/private_config*.sh >> "${outputfilefqdn}" 2>&1
    cp ${PrivateConfigAddFilefqfp} ${HOME}/ >> "${outputfilefqdn}" 2>&1
fi

if [ -f ${dotbashalliasesfilefqfp} ] ; then
    rm -f -v ${HOME}/${dotbashalliasestargetfile} >> "${outputfilefqdn}" 2>&1
    cp ${dotbashalliasesfilefqfp} ${HOME}/${dotbashalliasestargetfile} >> "${outputfilefqdn}" 2>&1
fi

cp ${dotbashrcmodfilefqfp} ${HOME}/ >> "${outputfilefqdn}" 2>&1
...
echo '===============================================================================' | tee -a "${outputfilefqdn}"
echo | tee -a "${outputfilefqdn}"
echo "Adding alias commands from ${alliasAddFilefqfp} to users ${HOME}/.bashrc file" | tee -a "${outputfilefqdn}"
echo | tee -a "${outputfilefqdn}"
...
#cat ${dotbashrcmodfilefqfp} >> ${HOME}/.bashrc | tee -a "${outputfilefqdn}"
#echo | tee -a "${outputfilefqdn}"
#
...
if [ $checkifaddalliasappended -eq 1 ] ; then
    ...
    echo "No need to append ${dotbashrcmodfilefqfp} to ${HOME}/.bashrc, already there." | tee -a "${outputfilefqdn}"
    echo | tee -a "${outputfilefqdn}"
else
    # ${alliasAddFile} is NOT appended, so append the file
    echo "Append ${dotbashrcmodfilefqfp} to ${HOME}/.bashrc" | tee -a "${outputfilefqdn}"
    echo | tee -a "${outputfilefqdn}"
