...
echo | tee -a "$outputfilefqdn"
echo '===============================================================================' | tee -a "$outputfilefqdn"
echo "Adding alias commands from $alliasAddFilefqfp to user's $HOME folder" | tee -a "$outputfilefqdn"
echo | tee -a "$outputfilefqdn"

dos2unix $alliasAddFilefqfp | tee -a "$outputfilefqdn"
dos2unix $dotbashrcmodfilefqfp | tee -a "$outputfilefqdn"

cp $alliasAddFilefqfp $HOME/ | tee -a "$outputfilefqdn"
cp $dotbashrcmodfilefqfp $HOME/ | tee -a "$outputfilefqdn"

echo | tee -a "$outputfilefqdn"
echo '===============================================================================' | tee -a "$outputfilefqdn"
echo '===============================================================================' | tee -a "$outputfilefqdn"
echo | tee -a "$outputfilefqdn"
echo "Adding alias commands from $alliasAddFilefqfp to user's $HOME/.bashrc file" | tee -a "$outputfilefqdn"
echo | tee -a "$outputfilefqdn"
