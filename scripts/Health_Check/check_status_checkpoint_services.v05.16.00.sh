...
echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}
echo 'https://opt/cloudinfra-gw-us.portal.checkpoint.com : Cloud Infrastructure Check' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}

Document_curl -v https://opt/cloudinfra-gw-us.portal.checkpoint.com
