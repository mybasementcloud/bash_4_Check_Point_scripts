...
#
# Reference SK:  https://support.checkpoint.com/results/sk/sk83520
#                 - How to verify that Security Gateway and/or Security Management Server can access Check Point servers?
# Reference SK:  https://support.checkpoint.com/results/sk/sk110779
#                 - "curl: (900) servercert: Error - server certificate validation failed!" when running "curl_cli" command
...
Document_curl () {
    ...
    curl_cli --cacert $CPDIR/conf/ca-bundle.crt --connect-timeout 10 -v "$@" 2> $templogerrorfile >> $templogfile
    curlerror=$?
...
# -------------------------------------------------------------------------------------------------
# Document_ping - Document ping command with log of error response (the actual response)
# -------------------------------------------------------------------------------------------------
...
Document_ping () {
    ...
    templogfile=${logfilepathbase}/${BASHScriptName}.${DATEDTGS}.ping_ops.log
    templogerrorfile=${logfilepathbase}/${BASHScriptName}.${DATEDTGS}.ping_ops.errout.log
    
    ping -c 5 "$@" 2> $templogerrorfile >> $templogfile
    pingerror=$?
    
    echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
    echo '| ping command | result = '$pingerror | tee -a -i ${logfilepath}
    echo '| # ping -c 5 '$@ | tee -a -i ${logfilepath}
    echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
...
# sk83520 Verifided - 2026-01-14

Document_nslookup cws.checkpoint.com

Document_curl http://cws.checkpoint.com/APPI/SystemStatus/type/short
Document_curl http://cws.checkpoint.com/URLF/SystemStatus/type/short
Document_curl http://cws.checkpoint.com/AntiVirus/SystemStatus/type/short
Document_curl http://cws.checkpoint.com/Malware/SystemStatus/type/short
...
#Document_curl -k https://updates.checkpoint.com/
# Updated 2026-01-14, IAW sk8350
Document_curl -k https://updates.checkpoint.com/WebService/Monitor

echo | tee -a -i ${logfilepath}
echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}
echo 'https://crl.godaddy.com : CRL that Update Service uses it for revocation' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}

# sk83520 Verifided - 2026-01-14

Document_nslookup crl.godaddy.com

Document_curl https://crl.godaddy.com/
...
Document_curl http://crl.globalsign.com/
...
Document_curl -k http://dl3.checkpoint.com
...
Document_curl -k https://usercenter.checkpoint.com/usercenter/services/ProductCoverageService
...
Document_curl https://usercenter.checkpoint.com/usercenter/services/BladesManagerService
...
Document_curl http://resolver1.chkp.ctmail.com
Document_curl http://resolver2.chkp.ctmail.com
Document_curl http://resolver3.chkp.ctmail.com
Document_curl http://resolver4.chkp.ctmail.com
Document_curl http://resolver5.chkp.ctmail.com
...
Document_curl http://download.ctmail.com
...
#Document_curl http://te.checkpoint.com
Document_curl -k https://te.checkpoint.com/tecloud/Ping
...
Document_curl http://teadv.checkpoint.com/version.txt
...
#Document_curl http://threat-emulation.checkpoint.com
Document_curl http://threat-emulation.checkpoint.com/tecloud/Ping
...
Document_curl https://ptcs.checkpoint.com
...
Document_curl https://ptcd.checkpoint.com
...
Document_curl http://kav8.zonealarm.com/version.txt
...
Document_curl http://kav8.checkpoint.com
...
Document_curl http://avupdates.checkpoint.com/UrlList.txt
...
Document_curl http://sigcheck.checkpoint.com/Siglist2.txt
...
#Document_curl secureupdates.checkpoint.com

# Updated 2026-01-14, IAW sk8350
Document_curl -I http://secureupdates.checkpoint.com/IP-list/100k.txt
...
Document_curl https://productcoverage.checkpoint.com/ProductCoverageService
...
Document_curl https://sc1.checkpoint.com/sc/images/checkmark.gif
Document_curl https://sc1.checkpoint.com/za/images/facetime/large_png/60342479_lrg.png
Document_curl https://sc1.checkpoint.com/za/images/facetime/large_png/60096017_lrg.png

Document_curl https://sc2.checkpoint.com/sc/images/checkmark.gif
Document_curl https://sc2.checkpoint.com/za/images/facetime/large_png/60342479_lrg.png
Document_curl https://sc2.checkpoint.com/za/images/facetime/large_png/60096017_lrg.png

Document_curl https://sc3.checkpoint.com/sc/images/checkmark.gif
Document_curl https://sc3.checkpoint.com/za/images/facetime/large_png/60342479_lrg.png
Document_curl https://sc3.checkpoint.com/za/images/facetime/large_png/60096017_lrg.png

Document_curl https://sc4.checkpoint.com/sc/images/checkmark.gif
Document_curl https://sc4.checkpoint.com/za/images/facetime/large_png/60342479_lrg.png
Document_curl https://sc4.checkpoint.com/za/images/facetime/large_png/60096017_lrg.png

Document_curl https://sc5.checkpoint.com/sc/images/checkmark.gif
Document_curl https://sc5.checkpoint.com/za/images/facetime/large_png/60342479_lrg.png
Document_curl https://sc5.checkpoint.com/za/images/facetime/large_png/60096017_lrg.png
...
Document_curl -k https://push.checkpoint.com/push/ping
...
Document_curl http://downloads.checkpoint.com
...
Document_curl http://productservices.checkpoint.com
...
echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}
echo 'diag-services.checkpoint.com :  Core Dump File uploader (Authentication / Upload backend)' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}

# sk83520 Verifided - 2026-01-14

Document_nslookup diag-services.checkpoint.com

Document_curl -k https://diag-services.checkpoint.com
...
echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}
echo 'mercury.ts.checkpoint.com' | tee -a -i ${logfilepath}
echo 'fairfax.ott.checkpoint.com' | tee -a -i ${logfilepath}
echo 'ftp-proxy.checkpoint.com :  File uploader for CPinfo, CP_Uploader, CPSizeMe (to a server in USA, Canada, Israel)' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}

# sk83520 Verifided - 2026-01-14

Document_nslookup mercury.ts.checkpoint.com

Document_curl -k mercury.ts.checkpoint.com

Document_nslookup fairfax.ott.checkpoint.com

Document_curl -k fairfax.ott.checkpoint.com

Document_nslookup ftp-proxy.checkpoint.com

Document_curl -k ftp-proxy.checkpoint.com
...
echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}
echo 'URL :  PURPOSE' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}

# sk83520 Verifided - 2026-01-14

Document_nslookup URL
...
echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}
echo 'rep.checkpoint.com :  Reputation service' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}
...
Document_curl -k https://rep.checkpoint.com -X POST -w '\nHTTP Status: %{http_code}\n'
...
echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}
echo 'cloudinfra-gw.portal.checkpoint.com :  To test connectivity with Smart-1 Cloud deployments in Europe' | tee -a -i ${logfilepath}
echo 'cloudinfra-gw-us.portal.checkpoint.com :  To test connectivity with Smart-1 Cloud deployments in the United States' | tee -a -i ${logfilepath}
#echo 'cloudinfra-gw.ap.portal.checkpoint.com :  To test connectivity with Smart-1 Cloud deployments in the APAC' | tee -a -i ${logfilepath}
echo '.maas.checkpoint.com :  On-premises Management Server and On-premises Security Gateways connect to the Smart-1 Cloud service' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}

# sk83520 Verifided - 2026-01-14

Document_nslookup .maas.checkpoint.com

Document_nslookup cloudinfra-gw.portal.checkpoint.com

#To test connectivity with Smart-1 Cloud deployments in Europe:
Document_curl cloudinfra-gw.portal.checkpoint.com
...
Document_curl cloudinfra-gw-us.portal.checkpoint.com

#Document_nslookup cloudinfra-gw.ap.portal.checkpoint.com

#To test connectivity with Smart-1 Cloud deployments in the APAC:
#Document_curl cloudinfra-gw.ap.portal.checkpoint.com


# -------------------------------------------------------------------------------------------------
# -------------------------------------------------------------------------------------------------
# Quantum Spark specific checks
# Reference SK:  https://support.checkpoint.com/results/sk/sk83520
#                 - How to verify that Security Gateway and/or Security Management Server can access Check Point servers?
#
...
echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
echo 'Quantum Spark specific checks' | tee -a -i ${logfilepath}
echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
...
echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}
echo 'dns.google.com :  Quantum Spark Gateways - Probing' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}

# sk83520 Verifided - 2026-01-14

Document_nslookup dns.google.com

Document_ping dns.google.com


echo | tee -a -i ${logfilepath}
echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}
echo 'dns.cloudflare.com' :  Quantum Spark Gateways - Probing | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}

# sk83520 Verifided - 2026-01-14

Document_nslookup dns.cloudflare.com

Document_ping dns.cloudflare.com


echo | tee -a -i ${logfilepath}
echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}
echo 'dns.opendns.com :  Quantum Spark Gateways - Probing' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}

# sk83520 Verifided - 2026-01-14

Document_nslookup dns.opendns.com

Document_ping dns.opendns.com
...
echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}
echo 'smbcloud-api-gateway.iaas.checkpoint.com :  Quantum Spark Gateways - Quantum Spark cloud services' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}

# sk83520 Verifided - 2026-01-14

Document_nslookup smbcloud-api-gateway.iaas.checkpoint.com

Document_curl -k https://smbcloud-api-gateway.iaas.checkpoint.com/health
...
echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}
echo '*.spark-management.checkpoint.com :  Quantum Spark Gateways- Quantum Spark Management - Quantum Spark Gateway activation' | tee -a -i ${logfilepath}
echo '*.spark-management.checkpoint.com :  Quantum Spark Gateways - CRL check' | tee -a -i ${logfilepath}
echo '*[.in].portal.checkpoint.com :  Quantum Spark Gateways - Infinity Portal services' | tee -a -i ${logfilepath}
echo '*.iaas.checkpoint.com :  Quantum Spark Gateways - Quantum Spark Gateway activation service' | tee -a -i ${logfilepath}
echo '*..ddnsbox.com :  Quantum Spark Gateways - Dynamic DNS (DDNS)' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}

# sk83520 Verifided - 2026-01-14

Document_nslookup spark-management.checkpoint.com

#Document_curl -k https://[domain].spark-management.checkpoint.com
#Document_curl -k http://[domain].spark-management.checkpoint.com

Document_nslookup portal.checkpoint.com
#Document_nslookup in.portal.checkpoint.com

#Document_curl -k https://[domain].portal.checkpoint.com
#Document_curl -k https://[domain]in.portal.checkpoint.com

Document_nslookup iaas.checkpoint.com

#Document_curl -k https://[domain].iaas.checkpoint.com

Document_nslookup ddnsbox.com

#Document_curl -k https://[domain].ddnsbox.com
...
# -------------------------------------------------------------------------------------------------
# -------------------------------------------------------------------------------------------------
# CloudGuard specific checks
# Reference SK:  https://support.checkpoint.com/results/sk/sk83520
#                 - How to verify that Security Gateway and/or Security Management Server can access Check Point servers?
#
# NOT ALL Checks are implemented
# CHECK if the required region is active!!
# -------------------------------------------------------------------------------------------------
# -------------------------------------------------------------------------------------------------
...
echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
echo 'CloudGuard specific checks' | tee -a -i ${logfilepath}
echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
...
echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}
echo 'api-cpx[.eu1|.ap2|.cace1|.ap3|.ap1].dome9.com :  CloudGuard agents for Kubernetes workloads - CloudGuard services' | tee -a -i ${logfilepath}
echo 'api[.eu1|.ap2|.cace1|.ap3|.ap1].dome9.com :  ' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}

# sk83520 Verifided - 2026-01-14

Document_nslookup api-cpx.dome9.com
Document_nslookup api.dome9.com

Document_curl -k https://api-cpx.dome9.com/namespaces -X POST
Document_curl -k https://api.dome9.com -X POST -w '\nHTTP Status: %{http_code}\n' -o /dev/null

Document_nslookup api-cpx.eu1.dome9.com
Document_nslookup api.eu1.dome9.com

Document_curl -k https://api-cpx.eu1.dome9.com/namespaces -X POST
Document_curl -k https://api.eu1.dome9.com -X POST -w '\nHTTP Status: %{http_code}\n' -o /dev/null

#Document_nslookup api-cpx.ap2.dome9.com
#Document_nslookup api.ap2.dome9.com

#Document_curl -k https://api-cpx.ap2.dome9.com/namespaces -X POST
#Document_curl -k https://api.ap2.dome9.com -X POST -w '\nHTTP Status: %{http_code}\n' -o /dev/null

#Document_nslookup api-cpx.cace1.dome9.com
#Document_nslookup api.cace1.dome9.com

#Document_curl -k https://api-cpx.cace1.dome9.com/namespaces -X POST
#Document_curl -k https://api.cace1.dome9.com -X POST -w '\nHTTP Status: %{http_code}\n' -o /dev/null

#Document_nslookup api-cpx.ap3.dome9.com
#Document_nslookup api.ap3.dome9.com

#Document_curl -k https://api-cpx.ap3.dome9.com/namespaces -X POST
#Document_curl -k https://api.ap3.dome9.com -X POST -w '\nHTTP Status: %{http_code}\n' -o /dev/null

#Document_nslookup api-cpx.ap1.dome9.com
#Document_nslookup api.ap1.dome9.com

#Document_curl -k https://api-cpx.ap1.dome9.com/namespaces -X POST
#Document_curl -k https://api.ap1.dome9.com -X POST -w '\nHTTP Status: %{http_code}\n' -o /dev/null
...
echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}
echo 'shiftleft.portal.checkpoint.com :  CloudGuard agents for Kubernetes workloads - Vulnerability scanner services' | tee -a -i ${logfilepath}
echo 'shiftleft-prod-bucket.sg.iaas.checkpoint.com :  ' | tee -a -i ${logfilepath}
echo '[us|eu|au|ca|in|sg]-gw.sg.iaas.checkpoint.com :  ' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}

# sk83520 Verifided - 2026-01-14

Document_nslookup shiftleft.portal.checkpoint.com

Document_curl -k https://shiftleft.portal.checkpoint.com

Document_nslookup shiftleft-prod-bucket.sg.iaas.checkpoint.com

Document_curl -k https://shiftleft-prod-bucket.sg.iaas.checkpoint.com

Document_nslookup us-gw.sg.iaas.checkpoint.com

Document_curl -k https://us-gw.sg.iaas.checkpoint.com

Document_nslookup eu-gw.sg.iaas.checkpoint.com

Document_curl -k https://eu-gw.sg.iaas.checkpoint.com

#Document_nslookup au-gw.sg.iaas.checkpoint.com

#Document_curl -k https://au-gw.sg.iaas.checkpoint.com

#Document_nslookup ca-gw.sg.iaas.checkpoint.com

#Document_curl -k https://ca-gw.sg.iaas.checkpoint.com

#Document_nslookup in-gw.sg.iaas.checkpoint.com

#Document_curl -k https://in-gw.sg.iaas.checkpoint.com

#Document_nslookup sg-gw.sg.iaas.checkpoint.com

#Document_curl -k https://sg-gw.sg.iaas.checkpoint.com
...
echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}
echo 'HEP/SBA:  s.sophosxl.net : Live Protection (E87.50 and higher)' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}

# sk116590 Verifided - 2026-01-14

Document_nslookup s.sophosxl.net

Document_nslookup -q=txt 3.1o19sr00npoo0416p3749589rq30n2n4n910n472s0231rrsq9no4453920p4po.ssrp3r741pr36393648s2r746nq062qqps480p3s0634o321o3onp9535o1nqrn.r51n42qo929pns005o3pp76q6qpnr344r79q7rpns970o957.q485ps774n160o80qpp046p53on3np2s7q787or4.i.01.s.sophosxl.net
...
echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}
echo 'HEP/SBA:  *.iaas.checkpoint.com : Threat Cloud' | tee -a -i ${logfilepath}
echo 'HEP/SBA:  file-rep.iaas.checkpoint.com : File reputation service (Horizon IOC)' | tee -a -i ${logfilepath}
echo 'HEP/SBA:  url-rep.iaas.checkpoint.com : URL reputation service (Horizon IOC)' | tee -a -i ${logfilepath}
echo 'HEP/SBA:  threatcloud.iaas.checkpoint.com : Malware service (Horizon IOC)' | tee -a -i ${logfilepath}
echo 'HEP/SBA:  te.iaas.checkpoint.com : Interaction with Threat Emulation cloud' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}

# sk116590 Verifided - 2026-01-14

Document_nslookup file-rep.iaas.checkpoint.com

Document_curl -k http://file-rep.iaas.checkpoint.com

Document_nslookup url-rep.iaas.checkpoint.com

Document_curl -k http://url-rep.iaas.checkpoint.com

Document_nslookup threatcloud.iaas.checkpoint.com

Document_curl -k http://threatcloud.iaas.checkpoint.com

Document_nslookup te.iaas.checkpoint.com

Document_curl -k http://te.iaas.checkpoint.com
...
echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}
echo 'HEP/SBA:  teadv.checkpoint.com : Anti-Malware engine and signature updates' | tee -a -i ${logfilepath}
echo | tee -a -i ${logfilepath}
...
Document_curl -k http://teadv.checkpoint.com/epupdates/86.50/0190/v1.xml
...
Document_curl -k gwevents.checkpoint.com
...
Document_curl http://malw-cws.checkpoint.com/Malware/SystemStatus/type/short
...
Document_curl -k http://secureupdates.checkpoint.com/AMW/Version
...
Document_curl -k http://sc1.checkpoint.com/EPcws/TCUrlsFormat.txt
...
Document_curl http://kav8.zonealarm.com/v6/index/u1313g.xml
...
for i in `seq 1 19` ; do
    if [ ${i} -le 9 ] ; then
        ...
        Document_curl http://dnl-0${i}.geo.kaspersky.com/index/u1313g.xml
    else
        Document_nslookup dnl-${i}.geo.kaspersky.com
        
        Document_curl http://dnl-${i}.geo.kaspersky.com/index/u1313g.xml
    fi
done
...
Document_curl -k https://rep.checkpoint.com/Phishing/status
...
Document_curl -k POST https://rep-cws.checkpoint.com/file-rep/SystemStatus/type/short
...
Document_curl -k POST https://sba-data-collection.iaas.checkpoint.com/upload
...
Document_curl -k -X GET https://datatube-prod.azurewebsites.net/health
...
Document_curl -k -X GET https://us-east4-chkp-gcp-rnd-threat-hunt-box.cloudfunctions.net/prod-gcp-contractprovider/health
...
Document_curl -k -X POST https://cloudinfra-gw.portal.checkpoint.com/auth/external
...
#echo '-----------------------------------------------------------------------------------------' | tee -a -i ${logfilepath}
#echo | tee -a -i ${logfilepath}
#echo 'HEP/SBA:  URL :  PURPOSE' | tee -a -i ${logfilepath}
#echo | tee -a -i ${logfilepath}
