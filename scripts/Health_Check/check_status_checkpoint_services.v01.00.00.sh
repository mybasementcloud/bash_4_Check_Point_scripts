...
curl_cli -v http://cws.checkpoint.com/APPI/SystemStatus/type/short;echo | tee -a -i $logfilepath
curl_cli -v http://cws.checkpoint.com/URLF/SystemStatus/type/short;echo | tee -a -i $logfilepath
curl_cli -v http://cws.checkpoint.com/AntiVirus/SystemStatus/type/short;echo | tee -a -i $logfilepath
curl_cli -v http://cws.checkpoint.com/Malware/SystemStatus/type/short;echo | tee -a -i $logfilepath
...
curl_cli -v -k https://updates.checkpoint.com/;echo | tee -a -i $logfilepath
...
curl_cli -v -k http://dl3.checkpoint.com;echo | tee -a -i $logfilepath
...
curl_cli -v -k https://usercenter.checkpoint.com/usercenter/services/ProductCoverageService;echo | tee -a -i $logfilepath
...
curl_cli -v --cacert $CPDIR/conf/ca-bundle.crt https://usercenter.checkpoint.com/usercenter/services/BladesManagerService;echo | tee -a -i $logfilepath
...
curl_cli -v http://resolver1.chkp.ctmail.com;echo | tee -a -i $logfilepath
curl_cli -v http://resolver2.chkp.ctmail.com;echo | tee -a -i $logfilepath
curl_cli -v http://resolver3.chkp.ctmail.com;echo | tee -a -i $logfilepath
curl_cli -v http://resolver4.chkp.ctmail.com;echo | tee -a -i $logfilepath
curl_cli -v http://resolver5.chkp.ctmail.com;echo | tee -a -i $logfilepath
...
curl_cli -v http://download.ctmail.com;echo | tee -a -i $logfilepath
...
curl_cli -v http://te.checkpoint.com;echo | tee -a -i $logfilepath
...
curl_cli -v http://teadv.checkpoint.com;echo | tee -a -i $logfilepath
...
curl_cli -v http://kav8.zonealarm.com/version.txt;echo | tee -a -i $logfilepath
...
curl_cli -v http://kav8.checkpoint.com;echo | tee -a -i $logfilepath
...
curl_cli -v http://avupdates.checkpoint.com/UrlList.txt;echo | tee -a -i $logfilepath
...
curl_cli -v http://sigcheck.checkpoint.com/Siglist2.txt;echo | tee -a -i $logfilepath
...
smp_connectivity_test smbmgmtservice.checkpoint.com;echo | tee -a -i $logfilepath
...
test zero-touch-request;echo | tee -a -i $logfilepath
...
rm index.html
wget http://secureupdates.checkpoint.com;echo | tee -a -i $logfilepath
rm index.html

curl_cli -v secureupdates.checkpoint.com;echo | tee -a -i $logfilepath
...
curl_cli -v https://productcoverage.checkpoint.com/ProductCoverageService;echo | tee -a -i $logfilepath
...
curl_cli -v https://sc1.checkpoint.com/sc/images/checkmark.gif;echo | tee -a -i $logfilepath
curl_cli -v https://sc1.checkpoint.com/za/images/facetime/large_png/60342479_lrg.png;echo | tee -a -i $logfilepath
curl_cli -v https://sc1.checkpoint.com/za/images/facetime/large_png/60096017_lrg.png;echo | tee -a -i $logfilepath
curl_cli -v https://sc2.checkpoint.com/sc/images/checkmark.gif;echo | tee -a -i $logfilepath
curl_cli -v https://sc2.checkpoint.com/za/images/facetime/large_png/60342479_lrg.png;echo | tee -a -i $logfilepath
curl_cli -v https://sc2.checkpoint.com/za/images/facetime/large_png/60096017_lrg.png;echo | tee -a -i $logfilepath
curl_cli -v https://sc3.checkpoint.com/sc/images/checkmark.gif;echo | tee -a -i $logfilepath
curl_cli -v https://sc3.checkpoint.com/za/images/facetime/large_png/60342479_lrg.png;echo | tee -a -i $logfilepath
curl_cli -v https://sc3.checkpoint.com/za/images/facetime/large_png/60096017_lrg.png;echo | tee -a -i $logfilepath
curl_cli -v https://sc4.checkpoint.com/sc/images/checkmark.gif;echo | tee -a -i $logfilepath
curl_cli -v https://sc4.checkpoint.com/za/images/facetime/large_png/60342479_lrg.png;echo | tee -a -i $logfilepath
curl_cli -v https://sc4.checkpoint.com/za/images/facetime/large_png/60096017_lrg.png;echo | tee -a -i $logfilepath
curl_cli -v https://sc5.checkpoint.com/sc/images/checkmark.gif;echo | tee -a -i $logfilepath
curl_cli -v https://sc5.checkpoint.com/za/images/facetime/large_png/60342479_lrg.png;echo | tee -a -i $logfilepath
curl_cli -v https://sc5.checkpoint.com/za/images/facetime/large_png/60096017_lrg.png;echo | tee -a -i $logfilepath
...
curl_cli -v https://push.checkpoint.com;echo | tee -a -i $logfilepath
...
curl_cli -v http://downloads.checkpoint.com;echo | tee -a -i $logfilepath
