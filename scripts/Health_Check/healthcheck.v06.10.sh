...
check_licenses()
{
    ...
    #Cleanup temp files
    rm -rf $contracts_temp_file
    rm -rf $expired_license_list_file
    rm -rf $expired_license_contract_list_file
    rm -rf $expiring_license_list_file
    rm -rf $missing_license_contract_list_file
    rm -rf $expiring_contract_list_file
    rm -rf $expired_contract_list_file
    rm -rf $duplicate_licenses_list_file
    rm -rf contract_temp*
