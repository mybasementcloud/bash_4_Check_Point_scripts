...
check_updates()
{
    ...
    if [[ $? -eq 0 ]]; then
        ...
        if [[ -n $curl_cmd ]]; then
            ...
            $curl_cmd -o $r81_10_temp 'https://supportcenter.checkpoint.com/supportcenter/portal?eventSubmit_doGoviewsolutiondetails=&solutionid=skxxxxxx' --insecure > /dev/null 2>&1
